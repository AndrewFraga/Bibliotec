...
/* package Bibliotec-0.0.0 */
#define VERSION_Bibliotec "0.0.0"
#define MIN_VERSION_Bibliotec(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
...
/* package monad-logger-0.3.24 */
#define VERSION_monad_logger "0.3.24"
#define MIN_VERSION_monad_logger(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  3 || \
  (major1) == 0 && (major2) == 3 && (minor) <= 24)
...
#define CURRENT_COMPONENT_ID "Bibliotec-0.0.0"

#define CURRENT_PACKAGE_KEY "Bibliotec-0.0.0"
